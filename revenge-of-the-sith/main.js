...
h1.textContent = "Star Wars: Revenge of the Sith";
...
var charactersData = dataLookup(people, chronologicalFilmsArr[5].characters);
...
var planetsData = dataLookup(planets, chronologicalFilmsArr[5].planets);
...
var speciesData = dataLookup(species, chronologicalFilmsArr[5].species);
...
var starshipsData = dataLookup(starships, chronologicalFilmsArr[5].starships);
...
var vehiclesData = dataLookup(vehicles, chronologicalFilmsArr[5].vehicles);
