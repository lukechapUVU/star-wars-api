...
h1.textContent = "Star Wars: The Force Awakens";
header.appendChild(h1);

let img = document.createElement('img');
img.src = `https://starwars-visualguide.com/assets/img/films/${7}.jpg`
...
var charactersData = dataLookup(people, chronologicalFilmsArr[6].characters);
...
var planetsData = dataLookup(planets, chronologicalFilmsArr[6].planets);
...
var speciesData = dataLookup(species, chronologicalFilmsArr[6].species);
...
var starshipsData = dataLookup(starships, chronologicalFilmsArr[6].starships);
...
var vehiclesData = dataLookup(vehicles, chronologicalFilmsArr[6].vehicles);
