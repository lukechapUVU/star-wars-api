...
h1.textContent = "Star Wars: Attack of the Clones";
header.appendChild(h1);

let img = document.createElement('img');
img.src = `https://starwars-visualguide.com/assets/img/films/${5}.jpg`
...
var charactersData = dataLookup(people, chronologicalFilmsArr[4].characters);
...
var planetsData = dataLookup(planets, chronologicalFilmsArr[4].planets);
...
var speciesData = dataLookup(species, chronologicalFilmsArr[4].species);
...
var starshipsData = dataLookup(starships, chronologicalFilmsArr[4].starships);
...
var vehiclesData = dataLookup(vehicles, chronologicalFilmsArr[4].vehicles);
