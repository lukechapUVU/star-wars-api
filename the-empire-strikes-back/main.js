...
h1.textContent = "Star Wars: The Empire Strikes Back";
header.appendChild(h1);

let img = document.createElement('img');
img.src = `https://starwars-visualguide.com/assets/img/films/${2}.jpg`
...
var charactersData = dataLookup(people, chronologicalFilmsArr[1].characters);
...
var planetsData = dataLookup(planets, chronologicalFilmsArr[1].planets);
...
var speciesData = dataLookup(species, chronologicalFilmsArr[1].species);
...
var starshipsData = dataLookup(starships, chronologicalFilmsArr[1].starships);
...
var vehiclesData = dataLookup(vehicles, chronologicalFilmsArr[1].vehicles);
