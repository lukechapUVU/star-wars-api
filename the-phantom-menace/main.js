...
h1.textContent = "Star Wars: The Phantom Menace";
header.appendChild(h1);

let img = document.createElement('img');
img.src = `https://starwars-visualguide.com/assets/img/films/${4}.jpg`
...
var charactersData = dataLookup(people, chronologicalFilmsArr[3].characters);
...
var planetsData = dataLookup(planets, chronologicalFilmsArr[3].planets);
...
var speciesData = dataLookup(species, chronologicalFilmsArr[3].species);
...
var starshipsData = dataLookup(starships, chronologicalFilmsArr[3].starships);
...
var vehiclesData = dataLookup(vehicles, chronologicalFilmsArr[3].vehicles);
