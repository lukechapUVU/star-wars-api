...
h1.textContent = "Star Wars: Return of the Jedi";
header.appendChild(h1);

let img = document.createElement('img');
img.src = `https://starwars-visualguide.com/assets/img/films/${3}.jpg`
...
var charactersData = dataLookup(people, chronologicalFilmsArr[2].characters);
...
var planetsData = dataLookup(planets, chronologicalFilmsArr[2].planets);
...
var speciesData = dataLookup(species, chronologicalFilmsArr[2].species);
...
var starshipsData = dataLookup(starships, chronologicalFilmsArr[2].starships);
...
var vehiclesData = dataLookup(vehicles, chronologicalFilmsArr[2].vehicles);
